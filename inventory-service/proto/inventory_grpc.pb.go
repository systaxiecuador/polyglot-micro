...
type InventoryServiceClient interface {
	...
	DecreaseStock(ctx context.Context, in *DecreaseStockRequest, opts ...grpc.CallOption) (*StockResponse, error)
}
...
func (c *inventoryServiceClient) DecreaseStock(ctx context.Context, in *DecreaseStockRequest, opts ...grpc.CallOption) (*StockResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StockResponse)
...
type InventoryServiceServer interface {
	...
	// RPC para disminuir stock (Escritura - Transaccional)
	DecreaseStock(context.Context, *DecreaseStockRequest) (*StockResponse, error)
...
func (UnimplementedInventoryServiceServer) DecreaseStock(context.Context, *DecreaseStockRequest) (*StockResponse, error) {
